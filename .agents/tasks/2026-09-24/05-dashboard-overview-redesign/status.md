...
- 2026-09-24: Deployed from `cd4dcb9`; verify and deploy jobs green. Live `/assets/dashboard.css` and `dashboard.js` confirmed the new rules and script behavior.
- Remaining: user manual QA of sidebar, topnav, and mobile.
