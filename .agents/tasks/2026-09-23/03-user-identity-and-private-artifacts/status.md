...
- Verification on 2026-09-23: 8 Bun gateway tests, TypeScript check, 23 Rust tests, `cargo fmt --check`, frozen Bun install, fresh isolated D1 migration, Drizzle generation parity, Wrangler types check, and Worker dry-run all passed.
